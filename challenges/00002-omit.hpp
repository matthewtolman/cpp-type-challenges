...
* Problem:
*
* We want to be able to create a new 'Omit' type whose properties are determined from a combination of a
* reference type and a list of fields to omit from that reference type. Only the fields *NOT* in that list
* should be part of the 'Omit' type. Their types should match the types on the reference type.
*
...
namespace omit_challenge {
    /*************************************
     * Setup types, do NOT change these
     *************************************/

    enum class OmitFields {
    ...
    template<class RefType, OmitFields ... Fields>
    struct Omit;
    ...
    using TestType1 = Omit<Todo, OmitFields::TITLE, OmitFields::DESCRIPTION>;
    ...
    using TestType2 = Omit<Todo, OmitFields::DESCRIPTION, OmitFields::COMPLETED>;
    ...
    using TestType3 = Omit<Assignment, OmitFields::DESCRIPTION, OmitFields::COMPLETED>;
    ...
    using TestType4 = Omit<Assignment, OmitFields::TITLE>;
